            ...
            <div className="flex justify-between w-full">
              <span className="text-secondary line-clamp-1 text-sm">
                {isContactPage ? (
                  ...
                  <div
                    className="flex items-center gap-1 max-w-[200px] sm:max-w-[200px] 
                                  md:max-w-[300px] lg:max-w-[200px] xl:max-w-[300px]"
                  >
              ...
              {
                data.totalUnreadMessages > 0 && <span className="bg-icon-green text-sm px-[5px] rounded-full">{data.totalUnreadMessages}</span>
              }
            </div>
          </div>
        </div>
